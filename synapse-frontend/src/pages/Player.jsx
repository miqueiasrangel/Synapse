...
function Player() {
  ...
  if (dashboards.length === 0) {
    return (
      <div style={styles.center}>
        ...
        <button onClick={() => navigate("/manager")} style={styles.backButton}>
  ...
  return (
    <div style={styles.fullScreen}>
      ...
      <button onClick={() => navigate("/manager")} style={styles.floatingButton} title="Voltar ao Gerenciador">
        ✖ Sair do Player
      </button>

      {/* O Iframe que exibe o Looker Studio */}
      <iframe src={dashboardAtual.url} style={styles.iframe} title={`Dashboard ${currentIndex + 1}`} allowFullScreen />
    </div>
  );
}
