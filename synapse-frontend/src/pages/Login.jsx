...
function Login() {
  ...
  const handleCadastro = async () => {
    ...
    try {
      await axios.post('http://localhost:8080/api/usuarios/cadastrar', { pin: pin });
  ...
  return (
    <div className="login-wrapper">
      <div className="login-card">
        ...
        <h1>Synapse</h1>
        <p className="login-subtitle">Gerenciador de Dashboards.<br/>Digite seu PIN corporativo para acessar.</p>
        ...
        <form onSubmit={handleLogin} className="login-form">
          ...
          {sucesso && <p style={{color: '#10b981', fontWeight: 'bold', margin: '0', fontSize: '0.95rem'}}>{sucesso}</p>}
